...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        { name: 'Dashboard', icon: <FaHome />, path: getDashboardPath(), roles: ['admin', 'student', 'faculty', 'donor'] },
        { name: 'Admin Panel', icon: <FaUserShield />, path: '/admin', roles: ['admin'] },
        { name: 'Students', icon: <FaUserGraduate />, path: '/students', roles: ['admin', 'faculty'] }, // Assuming faculty should see students
        { name: 'Faculty', icon: <FaChalkboardTeacher />, path: '/dashboard/faculty', roles: ['admin'] },
        { name: 'Donations', icon: <FaHandHoldingHeart />, path: '/donations', roles: ['admin'] }, // Usually admin only
        { name: 'Events', icon: <FaCalendarAlt />, path: '/events', roles: ['admin', 'student', 'faculty', 'donor'] },
        { name: 'Gallery', icon: <FaImages />, path: '/gallery', roles: ['admin', 'student', 'faculty', 'donor'] },
        { name: 'Settings', icon: <FaCog />, path: '/settings', roles: ['admin', 'student', 'faculty', 'donor'] },
    ];
